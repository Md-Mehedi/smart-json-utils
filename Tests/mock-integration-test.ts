 ...
 * 
 * This test can be run independently to verify sorting functionality
 * without the Angular testing framework.
 */

import * as fs from 'fs';
import * as path from 'path';

// Mock the Angular Injectable decorator and BehaviorSubject for Node.js
...
class JsonProcessorService {
  private arraySortPreferences: { [key: string]: string } = {};
  private arrayNestingPreferences: { [key: string]: boolean } = {};
  private arraySortOrderPreferences: { [key: string]: 'asc' | 'desc' } = {};
  ...
  sortObjectKeys(obj: any, parentPath = ''): any {
